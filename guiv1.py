...
reviews_url = 'https://www.amazon.in/product-reviews/B0761196MM/'
...
reviews = [get_reviews(html_data) for html_data in html_datas]
df_reviews = pd.DataFrame([review for sublist in reviews for review in sublist])
